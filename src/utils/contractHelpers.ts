...
import {
  getAddress,
  getbinanceProfileAddress,
  getbinanceRabbitsAddress,
...
// ABI
import profileABI from 'config/abi/binanceProfile.json'
import binanceRabbitsAbi from 'config/abi/binanceRabbits.json'
...
export const getProfileContract = (web3?: Web3) => {
  return getContract(profileABI, getbinanceProfileAddress(), web3)
}
export const getbinanceRabbitContract = (web3?: Web3) => {
  return getContract(binanceRabbitsAbi, getbinanceRabbitsAddress(), web3)
}
