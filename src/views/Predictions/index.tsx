...
import { useMatchBreakpoints, useModal } from '@binance/uikit'
...
const Predictions = () => {
  ...
  const [hasAcceptedRisk, setHasAcceptedRisk] = usePersistState(false, 'binance_predictions_accepted_risk')
  const [hasAcceptedChart, setHasAcceptedChart] = usePersistState(false, 'binance_predictions_chart')
