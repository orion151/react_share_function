...
import { Image, Heading, RowType, Toggle, Text } from '@binance/uikit'
...
const Farms: React.FC = () => {
  ...
  const [viewMode, setViewMode] = usePersistState(ViewMode.TABLE, 'binance_farm_view')
  ...
  const rowData = farmsStakedMemoized.map((farm) => {
    ...
    const lpLabel = farm.lpSymbol && farm.lpSymbol.split(' ')[0].toUpperCase().replace('binance', '')
  ...
  return (
    <>
      ...
      <Page>
        ...
        {renderContent()}
        <div ref={loadMoreRef} />
        <StyledImage src="/images/3dpan.png" alt="binance illustration" width={120} height={103} />
      </Page>
    </>
  )
}
