...
import { AutoRenewIcon, Button, Checkbox, Flex, InjectedModalProps, Text } from '@binance/uikit'
...
const PauseProfilePage: React.FC<PauseProfilePageProps> = ({ onDismiss }) => {
  ...
  const binanceProfileContract = useProfileContract()
  ...
  const handleDeactivateProfile = () => {
    binanceProfileContract.methods
      .pauseProfile()
      .send({ from: account })
      .on('sending', () => {
