...
import { Button, Flex, Text, InjectedModalProps } from '@binance/uikit'
...
const StartPage: React.FC<StartPageProps> = ({ goToApprove, goToChange, goToRemove, onDismiss }) => {
  ...
  useEffect(() => {
    const checkApprovalStatus = async () => {
      const response = await cakeContract.methods.allowance(account, getbinanceProfileAddress()).call()
