...
import { AutoRenewIcon, Button, Card, CardBody, Heading, Skeleton, Text } from '@binance/uikit'
import { Link as RouterLink } from 'react-router-dom'
import { useWeb3React } from '@web3-react/core'
import { getAddressByType } from 'utils/collectibles'
import { getbinanceProfileAddress } from 'utils/addressHelpers'
...
const ProfilePicture: React.FC = () => {
  ...
  const handleApprove = () => {
    contract.methods
      .approve(getbinanceProfileAddress(), selectedNft.tokenId)
      .send({ from: account })
      .once('sending', () => {
        setIsApproving(true)
      })
    ...
    return (
      <>
        ...
        <Text bold fontSize="20px" mb="24px">
          {t('We couldn’t find any binance Collectibles in your wallet.')}
        </Text>
        <Text as="p">
          {t(
            'You need a binance Collectible to finish setting up your profile. If you sold or transferred your starter collectible to another wallet, you’ll need to get it back or acquire a new one somehow. You can’t make a new starter with this wallet address.',
          )}
        </Text>
      </>
    )
      ...
      <Card mb="24px">
        <CardBody>
          ...
          <Text as="p" color="textSubtle" mb="24px">
            {t('Only approved binance Collectibles can be used.')}
