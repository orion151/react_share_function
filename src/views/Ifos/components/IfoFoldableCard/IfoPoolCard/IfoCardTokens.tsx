...
import { Text, Flex, Box, Image, CheckmarkCircleIcon, FlexProps, HelpIcon, useTooltip } from '@binance/uikit'
...
const IfoCardTokens: React.FC<IfoCardTokensProps> = ({
  ...
  const renderTokenSection = () => {
    ...
    if (account && !hasProfile) {
      return <Text textAlign="center">{t('You need an active binance Profile to take part in an IFO!')}</Text>
    }
