...
import { Stepper, Step, StepStatus, Card, CardBody, Heading, Text, Button, Link, OpenNewIcon } from '@binance/uikit'
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              You’ll need an active binance Profile to take part in an IFO!
            </Text>
            {isStepValid ? (
