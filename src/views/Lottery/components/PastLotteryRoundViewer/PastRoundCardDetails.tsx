...
import { Heading, CardBody, CardFooter, binanceRoundIcon, TicketRound } from '@binance/uikit'
      ...
      <>
        <CardBody>
          <CardHeading>
            ...
            <LotteryCardHeading valueToDisplay={t(`${poolSize.toLocaleString()} CAKE`)} Icon={binanceRoundIcon}>
              {t('Total prizes')}
            </LotteryCardHeading>
          </CardHeading>
        </CardBody>
